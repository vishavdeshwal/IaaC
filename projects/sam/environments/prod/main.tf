...
//
// NOTE: min_capacity here is what actually holds prod desired_count above
// the value declared on each ecs_service module (which is 1). Reducing the
// floors is the cost-optimisation lever — change deliberately.
// =============================================================
